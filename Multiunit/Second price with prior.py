...
'''
def getBid(my_bid, other_bids, num_item):
    bid = 0
    # numbers of bidder with the highest bids as me
    num_same = 1
    # number of bidders with higher bids than me
...
'''
def multiunit_soda_second_prior(end_time, n, bidders, num_item, priortype, parameter): # priortype = 1 power law priortype = 2 exponential distribution
            ...
            for bid_1 in range(0, n + 1):
                ...
                for value_combi in value_combinations:
                    for bid_combi in bid_combinations:
                        ...
                        utilities[bid_1] += beta_product *  prefactor * prior_product * (assignment * value_1 - payment_rule(getBid(bid_1, bid_combi, num_item), assignment)) / n
...
multiunit_soda_second_prior(10, 10, 3, 2, 1, 20)
